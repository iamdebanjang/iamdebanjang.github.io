<h1 id="current projects"></h1>

<h2 style="margin: 60px 0px -15px;">Projects</h2>
<br>


### Physics inspired bi-directional alternate reality Prediction:
...
### MirageNet: Physics-aware Mirage Segmentation 
